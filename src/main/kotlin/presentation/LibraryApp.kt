        ...
        if (true) {
            ...
            if (true) {
                ...
                for (book in checkedOutBooks) {
                    ...
                    if (bookInfoResult.isFailure) ctx.log.e(this,
            ...
            if (true) {
                ...
                if (availableBookToNumAvailableResult.isFailure) {
                    ...
                    throw Exception("AvailableBookIdCounts FAILURE! --> " +
                            availableBookToNumAvailableResult.exceptionOrNull()?.message
                    )
                }
...
//                        val libraryInfo3: LibraryInfo = Library.createInfoFromJson(
            ...
            if (true) {
                ...
                if (book12InfoResult.isFailure) {
                    ...
                    ctx.log.d(this, "User (2):" + user2.id() +
            ...
            if (true) {
                ...
                if (giveBookResult.isFailure) {
                    ctx.log.e(this, "Give Book FAILURE --> Book:" +
            ...
            if (true) {
                ...
                val book13 =
                    Book(book13id, null, ctx) // note: sourceLibrary is null, so this book comes from an ORPHAN Library
                ...
                if (transferResult1.isFailure) {
                    ...
                    ctx.log.d(this, "NEW Source Library: name=" +
